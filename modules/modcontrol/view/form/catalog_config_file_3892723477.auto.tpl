        ...
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none">
                            ...
                            <div class="tab-pane" id="catalog-config-file-tab4" role="tabpanel">
                                        ...
                                        <tr>
                                        <td class="otitle">{$elem.__affiliate_stock_restriction->getTitle()}&nbsp;&nbsp;{if $elem.__affiliate_stock_restriction->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__affiliate_stock_restriction->getHint()|escape}">?</a>{/if}
                                        </td>
                                        <td>{include file=$elem.__affiliate_stock_restriction->getRenderTemplate() field=$elem.__affiliate_stock_restriction}</td>
                                        </tr>
