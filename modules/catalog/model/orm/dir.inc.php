...
class Dir extends \RS\Orm\OrmObject
{
        ...
        parent::_init()->append(array(
            t('Основные'),
                    ...
                    'alias' => new Type\Varchar(array(
                        ...
                        'checker' => array(function($dir, $value, $error_text){
            ...
            t('Характеристики'),
                    '__property__' => new Type\UserTemplate('%catalog%/form/dir/property.tpl',null, array(
    ...
    */
    ...
    {
        return array(
            new \RS\Debug\Action\Edit(\RS\Router\Manager::obj()->getAdminPattern('treeEdit', array(':id' => '{id}'), 'catalog-ctrl')),
            new \RS\Debug\Action\Delete(\RS\Router\Manager::obj()->getAdminPattern('treeDel', array(':chk[]' => '{id}'), 'catalog-ctrl'))
        );
    }
    ...
    */
    ...
    {
        return (isset($this['recommended_arr']['product']) && !empty($this['recommended_arr']['product']));
    }
