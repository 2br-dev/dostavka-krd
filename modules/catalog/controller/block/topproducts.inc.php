...
class TopProducts extends StandartBlock
{
    ...
    protected static $controller_description = 'Отображает нужное количество товаров из заданной категории';
    ...
    function actionIndex()
    {
        ...
        if (!empty($dir_ids)) {
            $ids_with_childs = \RS\Cache\Manager::obj()->request(array($this->dirapi, 'getChildsId'), $dir_ids, SiteManager::getSiteId());
            ...
            $paginator = new \RS\Helper\Paginator($page, $total, $pageSize, \RS\Helper\Paginator::PATTERN_KEYREPLACE, array(), 'page');
