...
class File extends ConfigObject
{
    ...
    {
        $property_iterator  = parent::_init()->append(array(
            ...
            'use_seo_filters' => new Type\Integer(array(
            ...
            'not_public_category_404' => new Type\Integer(array(
            ...
            'not_public_property_dir_404' => new Type\Integer(array(
            ...
            'dependent_filters' => new Type\Integer(array(
            ...
            t('Обмен данными в CSV'),
                ...
                'csv_dont_delete_stocks' => new Type\Integer(array(
                    'maxLength' => 1,
                    'description' => t('Не удалять остатки на складах, созданные на сайте'),
                    'checkboxView' => array(1, 0),
                )),
                'csv_dont_delete_costs' => new Type\Integer(array(
                    'maxLength' => 1,
            ...
            t('Бренды'),
                'brand_products_specdir' => new Type\Integer(array(
                    ...
                    'tree' => array(array('\Catalog\Model\DirApi', 'staticSpecTreeList'), 0, array(0 => t('- Не выбрано -')))
                )),
                'brand_products_cnt' => new Type\Integer(array(
                    'description' => t('Кол-во товаров из спец. категории<br/> на странице бренда:'),
                )),
                'brand_products_hide_unobtainable' => new Type\Integer(array(
            ...
            t('Складской учет'),
                'inventory_control_enable' => new Type\Integer(array(
                    'visible' => false,
                    'description' => t('Включить складской учет'),
                )),
                'ic_enable_button' => new Type\Integer(array(
                    'checkboxView' => array(1, 0),
                    'default' => 0,
                    'template' => '%catalog%/form/inventory/enable_button.tpl',
                    'description' => t('Складской учет'),
                )),
                'provider_user_group' => new Type\Varchar(array(
                ...
                'csv_id_fields_ic' => new Type\Varchar(array(
                    'runtime' => false,
                    'description' => t('Поле для идентификации товара при импорте csv'),
                    'list' => array(array('\Catalog\Model\Inventory\InventoryTools','getPossibleIdFields')),
                    'default'  => 'barcode',
                )),
            t('Настройки импорта YML'),
                'yuml_import_setting' => new Type\Varchar(array(
                    ...
                    'tree' => array(array('\Catalog\Model\Dirapi', 'staticTreeList'), 0, array(0 => t('- Корень каталога -')))
                )),
                ...
                'save_product_public' => new Type\Integer(array(
                    'description' => t('Сохранять публичность товаров'),
                    'default' => 1,
                    'CheckboxView' => array(1, 0),
                )),
                'save_product_dir' => new Type\Integer(array(
                ...
                'use_htmlentity' => new Type\Integer(array(
                    'description' => t('Не использовать htmlentity'),
                    'default' => 0,
                    'CheckboxView' => array(1, 0),
                )),
                'increase_cost' => new Type\Integer(array(
                    'description' => t('Увеличить цену на %'),
                    'default' => 0,
                )),
                'use_vendorcode' => new Type\Varchar(array(
                    'maxLength' => '50',
            ...
            t('Параметры товаров'),
                'default_product_meta_title' => new Type\Varchar(array(
                    'maxLength' => '1000',
                    'description' => t('Заголовок товаров по умолчанию'),
                )),
                'default_product_meta_keywords' => new Type\Varchar(array(
                    'maxLength' => '1000',
                    'description' => t('Ключевые слова товаров по умолчанию'),
                )),
                'default_product_meta_description' => new Type\Varchar(array(
                    'maxLength' => '1000',
                    'viewAsTextarea' => true,
                ...
                'property_product_length' => new Type\Integer(array(
                    'description' => t('Характеристика "Длинна товара"'),
                    'list' => array(array('Catalog\Model\PropertyApi', 'staticSelectList')),
                )),
                'default_product_length' => new  Type\Decimal([
                    'description' => t('Длинна товара по умолчанию'),
                ]),
                'property_product_width' => new Type\Integer(array(
                ...
                'property_product_height' => new Type\Integer(array(
                ...
                'dimensions_unit' => new Type\Enum(array_keys(ProductDimensions::handbookDimensionsUnits()), array(
                    'description' => t('Единица измерения габаритов товаров'),
                    'listFromArray' => array(ProductDimensions::handbookDimensionsUnits()),
                )),
        ));
        ...
        if (ModuleManager::staticModuleExists('affiliate') && ModuleManager::staticModuleEnabled('affiliate')) {
            $property_iterator->append([
                t('Склады'),
                    'affiliate_stock_restriction' => new Type\Integer(array(
    ...
    public static function getDefaultValues()
    {
        return parent::getDefaultValues() + array(
            'tools' => array(
                array(
                    'url' => RouterManager::obj()->getAdminUrl('ajaxCleanProperty', array(), 'catalog-tools'),
                ...
                array(
                    'url' => RouterManager::obj()->getAdminUrl('ajaxCleanOffers', array(), 'catalog-tools'),
                ...
                array(
                    'url' => RouterManager::obj()->getAdminUrl('ajaxCleanRelatedProducts', array(), 'catalog-tools'),
                ...
                array(
                    'url' => RouterManager::obj()->getAdminUrl('ajaxCheckAliases', array(), 'catalog-tools'),
                ...
                array(
                    'url' => RouterManager::obj()->getAdminUrl('ajaxCheckBrandsAliases', array(), 'catalog-tools'),
                ...
                array(
                    'url' => RouterManager::obj()->getAdminUrl('ajaxCheckPropertyAliases', array(), 'catalog-tools'),
                ...
                array(
                    'url' => RouterManager::obj()->getAdminUrl('ajaxCreateMainOffers', array(), 'catalog-tools'),
                ...
                array(
                    'url' => RouterManager::obj()->getAdminUrl('ajaxReIndexProducts', array(), 'catalog-tools'),
                ...
                array(
                    'url' => RouterManager::obj()->getAdminUrl('ajaxCleanImportHash', array(), 'catalog-tools'),
                ...
                array(
                    'url' => RouterManager::obj()->getAdminUrl('openArchiveWindow', array('mode' => InventoryTools::$do_archive), 'catalog-inventoryctrl', true),
                ...
                array(
                    'url' => RouterManager::obj()->getAdminUrl('openArchiveWindow', array('mode' => InventoryTools::$do_unarchive), 'catalog-inventoryctrl', true),
