        ...
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none"/>
                        ...
                        <div class="tab-pane" id="users-user-tab9" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__date_arrive->getTitle()}&nbsp;&nbsp;{if $elem.__date_arrive->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__date_arrive->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__date_arrive->getRenderTemplate() field=$elem.__date_arrive}</td>
                                </tr>
