...
(function( $ ){
    ...
    $.fn.onePageCheckout = function( method ) {
        var defaults = {
            ...
            loading         : 'inloading', //Класс который будет добавлятся блоку во время загрузки
        ...
        return this.each(function() {
            ...
            var methods = {
                init: function(initoptions) {
                    ...
                    $('body')
                        ...
                        .on('change', data.options.radioPayment, methods.ajaxGetBlocks); //Смена типа оплаты
            ...
            */
            ...
            firstInit = function(){
                ...
                console.log(data.options.oneTab);
            ...
            */
            deliveryToggle = function(){
                ...
                methods.ajaxGetBlocks(); //Обновим блоки    
            },
            ...
            */
            keyUpInput = function (){
               ...
               if ($(this).data('val') != val) { //Если значение у поля уже другое
                  ...
                  data.options.inputTimeout = setTimeout(methods.ajaxGetBlocks, data.options.inputTimeoutTime);
                  $(this).data('val',val); 
               }
            },
