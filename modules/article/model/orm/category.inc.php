...
class Category extends OrmObject
{
        ...
        parent::_init()->append(array(
            t('Основные'),
                ...
                'parent' => new Type\Integer(array(
                    ...
                    'tree' => array(array('\Article\Model\CatApi', 'staticTreeList'), 0, array('' => t('- Верхний уровень -'))),
                )),
    ...
    {
        return RouterManager::obj()->getUrl('article-front-previewlist', array('category' => $this->getUrlId()), $absolute);
    }
