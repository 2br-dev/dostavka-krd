...
class Article extends OrmObject
{
    ...
    protected function _init()
    {
        parent::_init()->append(array(
            t('Основные'),
                    ...
                    'parent' => new Type\Integer(array(
                        ...
                        'tree' => array(array(new CatApi(), 'staticTreeList'), 0, array('' => t('- Верхний уровень -'))),
                    )),
        ...
        $this->addIndex(array('site_id', 'parent', 'alias'), self::INDEX_UNIQUE);
    }
    ...
    */
    ...
    {
        return array(
            new \RS\Debug\Action\Edit(RouterManager::obj()->getAdminPattern('edit', array(':id' => '{id}'), 'article-ctrl')),
            new \RS\Debug\Action\Delete(RouterManager::obj()->getAdminPattern('del', array(':chk[]' => '{id}'), 'article-ctrl'))
        );
    }
