...
class Manager
{
    ...
    public
        ...
        $expire = CACHE_TIME; //в секундах, срок в течении котороо кэш считается валидным. 0 - бессрочно (для ручной инвалидации)
    ...
    */
    ...
    /**
    * Устанавливает срок в секундах в течении котороо кэш считается валидным. Сбрасывается после вызова метода request
    * 
    ...
    * @return string
    */
    protected function keyByCallback($callback, $params = array())
    {        
        if (is_array($callback)) {
    ...
    */
    ...
    {
        if ($tables instanceof \RS\Orm\AbstractObject) $tables = array($tables->_getTableArray());
