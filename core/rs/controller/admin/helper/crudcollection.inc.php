...
class CrudCollection implements \ArrayAccess
{
    ...
    * @return CrudCollection
    */
    function addCsvButton($schema, $additional_export_params = array())
    {
        $this['topToolbar']->addItem(new ToolbarButton\Dropdown(array(
            ...
            array(
                'title' => t('Экспорт CSV'),
                'attr' => array(
                    'href' => \RS\Router\Manager::obj()->getAdminUrl('exportCsv', array('schema' => $schema, 'referer' => $this->url->selfUri(), 'params' => $additional_export_params), 'main-csv'),
                    'class' => 'crud-add'
                )
            ),
            array(
    ...
    */
    ...
    function setCategory(Html\Category\Element $category, $api = null)
    {
        ...
        $this->collection['category'] = new Html\Category\Control(array(
            'category' => $category,
            'AutoFill' => false
        ));
        return $this;
    ...
    */
    function active()
    {
        $referer = $this->url ? array('referer' => $this->url->getSelfUrl()) : array();
        ...
        if ($this->appendModuleOptionsButton) {
            ...
            $this['topToolbar']->addItem(new ToolbarButton\ModuleConfig(\RS\Router\Manager::obj()->getAdminUrl('edit', array('mod' => $module_name) + $referer, 'modcontrol-control')));
        }
