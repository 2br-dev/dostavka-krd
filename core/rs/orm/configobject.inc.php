...
abstract class ConfigObject extends AbstractObject implements \RS\Module\ConfigInterface
{
    ...
    /** @deprecated (08.18) */
    const ACCESS_BIT_READ = 0; //Разрешение на Чтение
    /** @deprecated (08.18) */
    const ACCESS_BIT_WRITE = 1; //разрешение на Запись
    /** @deprecated (08.18) */
    const BIT_COUNT = 8; //Количество битов для прав модулей
    ...
    {
        return new StorageSerialized($this, array(
            'primary' => array(
