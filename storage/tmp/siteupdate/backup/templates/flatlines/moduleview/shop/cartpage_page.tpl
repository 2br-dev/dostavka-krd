                                    ...
                                    <div class="card-text">
                                        ...
                                        <div class="card-product_quantity">
                                            <div class="quantity rs-amount">
                                                <input type="number" value="{$cartitem.amount}" min="{$product->getAmountStep()}" step="{$product->getAmountStep()}" name="products[{$index}][amount]" class="rs-field-amount">
                                        ...
                                        <div class="card-text">
                                            ...
                                            <div class="card-product_quantity">
                                                {if $shop_config.allow_concomitant_count_edit}
                                                    <div class="quantity rs-amount">
                                                        <input type="number" min="{$sub_product->getAmountStep()}" step="{$sub_product->getAmountStep()}" class="rs-field-amount rs-concomitant" data-id="{$sub_product->id}" value="{$sub_product_data.amount}" name="products[{$index}][concomitant_amount][{$sub_product->id}]">
                                                        <div class="quantity-nav">
                                                            <div class="quantity-unit">
                                                                {if $catalog_config.use_offer_unit}
                                                                    {$product.offers.items[$cartitem.offer]->getUnit()->stitle}
