                            ...
                            <div class="t-drop-basket__list_item">
                                ...
                                <div class="t-drop-basket__list_item-price">
                                    <div class="quantity-float rs-amount{if $item.amount_error} amount-error{/if}">
                                        <input type="hidden" step="{$product->getAmountStep()}" class="rs-field-amount" value="{$cartitem.amount}" name="products[{$index}][amount]"/>
                                        {if !$cartitem->getForbidChangeAmount()}
                                            <a class="quantity-button quantity-down rs-dec" data-amount-step="{$product->getAmountStep()}">-</a>
                                        {/if}
                                        <div class="quantity-num-wrapper">
                                            <span class="rs-num" {if $item.amount_error}title="{$item.amount_error}"{/if}>{$cartitem.amount}</span>
                                            <span class="unit">
                                        ...
                                        {if !$cartitem->getForbidChangeAmount()}
                                            <a class="quantity-button quantity-up rs-inc" data-amount-step="{$product->getAmountStep()}">+</a>
                                        {/if}
                                    </div>
                                    ...
                                    <div class="t-drop-basket__list_item">
                                        ...
                                        <div class="t-drop-basket__list_item-price">
                                            {if $shop_config.allow_concomitant_count_edit}
                                                <div class="quantity-float rs-amount{if $item.amount_error} amount-error{/if}">
                                                    <input type="hidden" step="{$sub_product->getAmountStep()}" class="rs-field-amount rs-concomitant" data-id="{$sub_product->id}" value="{$sub_product_data.amount}" name="products[{$index}][concomitant_amount][{$sub_product->id}]">
