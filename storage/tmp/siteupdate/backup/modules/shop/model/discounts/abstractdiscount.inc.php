...
abstract class AbstractDiscount
{
     ...
     */
    public function __construct(float $discount, string $unit, string $source)
    {
    ...
    {
        $object = new static($array[self::SAVE_KEY_DISCOUNT], $array[self::SAVE_KEY_UNIT], $array[self::SAVE_KEY_SOURCE]);
        return $object;
    }
