...
abstract class AbstractType
{
    ...
    */
     ...
     * @return string
     */
    function makeRightAbsoluteUrl($relative_url)
    {
        ...
        $uri = $current_site ? $current_site->getAbsoluteUrl($relative_url) : \RS\Http\Request::commonInstance()->getSelfAbsoluteHost().$relative_url;
