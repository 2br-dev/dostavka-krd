        ...
        <div class="rs-has-account">
            <div class="workArea">
                ...
                <div class="form__menu_buttons">
                    <button type="submit" class="link link-more" id="order_login">{t}Войти{/t}</button>
    ...
    {if $have_to_address_delivery && $shop_config->isCanShowAddress()}
        <div class="t-order_contact-information">
            ...
            <div id="form-address-section-wrapper" class="{if $have_pickup_points && $order.only_pickup_points}hidden{/if}">
                ...
                <div class="rs-new-address" {if $order.use_addr>0 && $address_list}style="display:none;"{/if}>
