...
<div class="onePageProductsBlock over__final-wrap">           
    ...
    <div class="coItems">
        ...
        <div class="commentSection over__final">
            <p class="over__final-title">{t}Комментарий{/t}</p>
            {$order.__comments->formView()}
        </div>
        <div class="summary over__sum">
            <p class="over__sum-title">{t}Итого{/t}: </p>
            <p class="over__sum-title">{$cartdata.total}</p>
        </div>            
    </div>
</div>