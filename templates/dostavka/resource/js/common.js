$.extend({
    /**
    * Загружает контент в диалоговом окне. Зависит от jquery.colorbox, jquery.form 111111
    */
        ...
        var methods = {
            ...
            */
            ...
            updateCartBlock: function(serverData) {
                if (serverData) {
                    $(data.options.cartTotalItems).text(serverData.cart.items_count);
                    ...
                    $('.fixedCart').show("slide", { direction: "right" }, 500);
                }
            },
