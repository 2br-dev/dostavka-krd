...
(function($){
    ...
    {
        $('body').off('mouseover.showPlusesOver', val)
                 .off('mouseout.showPlusesOut', val);
    ...
    function addMouseEventToShowPlusesForBlocks(type)
    {
        ...
        needed_blocks.forEach((needed_block) => {
             ...
             */
            body.on('mouseover.showPlusesOver', needed_block, function(e){
                //Определим координаты для проверки
                let coorTop    = $(this).offset().top;
                let coorBottom = $(this).offset().top + $(this).outerHeight();
                ...
                $(this).on('mousemove.showPlusesMove', function(event){ //Покажем нужный плюсик
                    ...
                    //Верхний плюс
                    let coorTopCheck1 = coorTop - 33;
                    let coorTopCheck2 = coorTop + 33;
                    if (mousePos > coorTopCheck1 && mousePos < coorTopCheck2){ //Добавим верхнему плюсу событие
                        pluses_top.addClass('highlight');
                    }
                    //Нижний плюс
                    let coorBottomCheck1 = coorBottom - 33;
                    let coorBottomCheck2 = coorBottom + 33;
             ...
             */
            .on('mouseout.showPlusesOut', needed_block, function(){
    ...
    $(function() {
        ...
        {
            body.append("<div id='dragAllHandler' class='drag-module-block-handlerplace' style='width:20px;height:20px;'></div>");//Блок перетаскивания
